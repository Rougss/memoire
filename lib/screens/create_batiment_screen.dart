...
class _CreateBatimentScreenState extends State<CreateBatimentScreen> with TickerProviderStateMixin {
  ...
  Future<void> _submitForm() async {
    ...
    try {
      await BatimentService.createBatiment(
                                  ...
                                  Container(
                                    ...
                                    child: TextFormField(
                                      ...
                                      decoration: InputDecoration(
                                        hintText: 'Ex: Bâtiment Principal, Tour A...',
                                      ...
                                      validator: (value) {
                                        if (value == null || value.trim().isEmpty) {
                                          return 'Veuillez entrer un nom pour le bâtiment';
                                        }
